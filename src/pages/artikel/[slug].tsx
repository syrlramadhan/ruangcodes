  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={`https://ruangcodes.vercel.app/images/${slug}`} />
        <meta property="og:image:secure_url" content={`https://ruangcodes.vercel.app/images/${slug}`} />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${title} | RuangCodes`} />
        <meta name="twitter:description" content={description} />
        <meta name="twitter:image" content={`https://ruangcodes.vercel.app/images/${slug}`} />

        {/* Fallback untuk platform yang baca <meta name="image"> */}
        <meta name="image" content={`https://ruangcodes.vercel.app/images/${slug}`} />
        <link
